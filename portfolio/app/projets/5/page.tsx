    ...
    <section className="min-h-screen flex flex-col items-center bg-blue-800 text-gray-100 py-16 px-4">
      ...
      <div className="w-full max-w-6xl bg-white/20 backdrop-blur-md rounded-2xl shadow-lg p-8 flex flex-col md:flex-row gap-10">
        ...
        <div className="w-16" />
          ...
          {/* Titre */}
          <h2 className="text-3xl font-bold text-white">G'Présent</h2>

          {/* Description */}
          <p className="text-gray-200 leading-relaxed">
{/* G’Présent is a system that automatically manages student attendance in a classroom. There’s no need to take roll calls during class, saving time. It is a connected system: at the entrance, a fingerprint scan and a card scan are required. */}
ONGOING PROJECTS <br />
It uses modern technologies such as Next.js and MySQL for the interface, along with an ESP32 microcontroller.
          </p>
