...
export default function Projet1() {
  const images = [
    "/portfolioancien1.png",
       "/portfolioancien2.png",
       "/portfolioancien3.png",
  ];
    ...
    <section className="min-h-screen flex flex-col items-center bg-blue-800 text-gray-100 py-16 px-4">
      ...
      <div className="w-full max-w-6xl bg-white/20 backdrop-blur-md rounded-2xl shadow-lg p-8 flex flex-col md:flex-row gap-10">
        ...
        <div className="w-16" />
          ...
          {/* Titre */}
          <h2 className="text-3xl font-bold text-white">Ancien Portfolio</h2>

          {/* Description */}
          <p className="text-gray-200 leading-relaxed">
Old and first portfolio deployed, created using the Angular framework.         </p>
