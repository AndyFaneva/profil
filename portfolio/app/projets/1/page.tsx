    ...
    <section className="min-h-screen flex flex-col items-center bg-blue-800 text-gray-100 py-16 px-4">
      ...
      <div className="w-full max-w-6xl bg-white/20 backdrop-blur-md rounded-2xl shadow-lg p-8 flex flex-col md:flex-row gap-10">
        ...
        <div className="w-16" />
          ...
          {/* Titre */}
          <h2 className="text-3xl font-bold text-white">SaVir</h2>

          {/* Description */}
          <p className="text-gray-200 leading-relaxed">
Savir, or Virtual Student Fair, is a personal project that I created.
It allowed me to put into practice my knowledge of HTML, CSS, JavaScript, and PHP.
As well as the relational database used, MySQL.
The project aims to bring together all the stands of a fair on a single website.
          </p>
