    ...
    <section className="min-h-screen flex flex-col items-center bg-blue-800 text-gray-100 py-16 px-4">
      ...
      <div className="w-full max-w-6xl bg-white/20 backdrop-blur-md rounded-2xl shadow-lg p-8 flex flex-col md:flex-row gap-10">
        ...
        <div className="w-16" />
          ...
          {/* Titre */}
          <h2 className="text-3xl font-bold text-white">C'MADA Pro</h2>

          {/* Description */}
          <p className="text-gray-200 leading-relaxed">
C'MADA PRO is a B2B commercialization system that helps promote Malagasy local products abroad.
It is a project developed for both web and mobile, using modern technologies such as React, NestJS, React Native and MySQL. </p>
