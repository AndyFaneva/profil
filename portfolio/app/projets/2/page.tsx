    ...
    <section className="min-h-screen flex flex-col items-center bg-blue-800 text-gray-100 py-16 px-4">
      ...
      <div className="w-full max-w-6xl bg-white/20 backdrop-blur-md rounded-2xl shadow-lg p-8 flex flex-col md:flex-row gap-10">
        ...
        <div className="w-16" />
          ...
          {/* Titre */}
          <h2 className="text-3xl font-bold text-white">GPI</h2>

          {/* Description */}
          <p className="text-gray-200 leading-relaxed">
GPI, or IT Park Management, is an academic project carried out to showcase web development skills, using HTML, CSS, JavaScript, PHP, and MySQL.
It allowed me to work on a real-world project that could actually be used and deployed in real time.
          </p>
